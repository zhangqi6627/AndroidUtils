...
class KeyObject {
	...
	/**
	 * Key code constant: Soft Right key. Usually situated below the display on phones and used as a multi-function feature key for selecting a software defined function shown on the bottom right of
	 * the display.
	 */
	...
	/**
	 * Key code constant: Number modifier key. Used to enter numeric symbols. This key is not Num Lock; it is more like {@link #KEYCODE_ALT_LEFT} and is interpreted as an ALT key by
	...
	/**
	 * Key code constant: Volume Mute key. Mutes the speaker, unlike {@link #KEYCODE_MUTE}. This key should normally be implemented as a toggle such that the first press mutes the speaker and the
	...
	/**
	 * Key code constant: Language Switch key. Toggles the current input language such as switching between English and Japanese on a QWERTY keyboard. On some devices, the same function may be
	 * performed by pressing Shift+Spacebar.
	 */
	public static final int KEYCODE_LANGUAGE_SWITCH = 204;
	/**
	 * Key code constant: Manner Mode key. Toggles silent or vibrate mode on and off to make the device behave more politely in certain settings such as on a crowded train. On some devices, the key
	 * may only operate when long-pressed.
	 */
	...
	/**
	 * M:[SmartBook] Key code constant: messaging key. Starts the system messaging activity.
	 * 
	 * @hide
	 */
	public static final int KEYCODE_MESSAGING = 227;
	/**
	 * M:[SmartBook] Key code constant: gallery key. Starts the system gallery activity.
	 * 
	 * @hide
	 */
	...
	/** 键值 */
	private int keyCode;
	public KeyObject(String keyName, int keyCode) {
		this.keyName = keyName;
		this.keyCode = keyCode;
	}
}